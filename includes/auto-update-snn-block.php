...
// Configuration
$update_proxy_url = 'https://sinanisler.com/snn-block-github/update.php';
...
function snn_brx_github_redirect_version_link() {
    ...
    <script type="text/javascript">
        (function() {
            const githubUrl = 'https://github.com/sinanisler/snn-block/releases';
            ...
            function modifyLink(link) {
                ...
                const firstLink = notice.querySelector('a[aria-label*="SNN-BLOCK"]');
            ...
            function processLinks() {
                ...
                notices.forEach(function(notice) {
                    const firstLink = notice.querySelector('strong a[aria-label*="SNN-BLOCK"]:first-of-type');
                    if (firstLink) {
                    ...
                    mutation.addedNodes.forEach(function(node) {
                        if (node.nodeType === 1) {
                            if (node.classList && node.classList.contains('notice')) {
                                const firstLink = node.querySelector('strong a[aria-label*="SNN-BLOCK"]:first-of-type');
                                if (firstLink) {
                                    modifyLink(firstLink);
                                }
                            }
