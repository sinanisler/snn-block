...
registerBlockType('snn/container', {
    ...
    edit: function (props) {
        ...
        const blockProps = useBlockProps({ className:'snn-container', style:previewStyles });
            ...
            <Fragment>
                <InspectorControls>
                    ...
                    {isFlex && <div>
                        <div style={{ display:'flex',gap:'4px',marginBottom:'4px' }}>
                            <select value={getVal('flexDirection')} onChange={e => setVal('flexDirection',e.target.value)} style={sel}>
                                <option value="">Dir</option><option value="row">Row</option><option value="column">Col</option>
                                <option value="row-reverse">Row R</option><option value="column-reverse">Col R</option>
                            </select>
                            <select value={getVal('flexWrap')} onChange={e => setVal('flexWrap',e.target.value)} style={sel}>
                                <option value="">Wrap</option><option value="wrap">Wrap</option><option value="nowrap">No</option>
                            </select>
                        </div>
                        <div style={{ display:'flex',gap:'4px',marginBottom:'4px' }}>
                            <select value={getVal('justifyContent')} onChange={e => setVal('justifyContent',e.target.value)} style={sel}>
                                <option value="">Justify</option><option value="flex-start">Start</option><option value="center">Center</option>
                                <option value="flex-end">End</option><option value="space-between">Between</option><option value="space-around">Around</option>
                            </select>
                            <select value={getVal('alignItems')} onChange={e => setVal('alignItems',e.target.value)} style={sel}>
                                <option value="">Align</option><option value="flex-start">Start</option><option value="center">Center</option>
                    ...
                    {isGrid && <div>
                        ...
                        <div style={{ display:'flex',gap:'4px',marginBottom:'4px' }}>
                            <select value={getVal('justifyItems')} onChange={e => setVal('justifyItems',e.target.value)} style={sel}>
                            ...
                            <select value={getVal('alignItems')} onChange={e => setVal('alignItems',e.target.value)} style={sel}>
                                <option value="">Align Items</option><option value="start">Start</option><option value="center">Center</option>
                                <option value="end">End</option><option value="stretch">Stretch</option>
                            </select>
                        </div>
                        <div style={{ display:'flex',gap:'4px',marginBottom:'4px' }}>
                            <select value={getVal('justifyContent')} onChange={e => setVal('justifyContent',e.target.value)} style={sel}>
                                <option value="">Justify Content</option><option value="start">Start</option><option value="center">Center</option>
                                <option value="end">End</option><option value="space-between">Between</option><option value="space-around">Around</option><option value="space-evenly">Evenly</option>
                            </select>
                            <select value={getVal('alignContent')} onChange={e => setVal('alignContent',e.target.value)} style={sel}>
                                <option value="">Align Content</option><option value="start">Start</option><option value="center">Center</option>
                                <option value="end">End</option><option value="space-between">Between</option><option value="space-around">Around</option><option value="stretch">Stretch</option>
                            </select>
                        </div>
                    </div>}
