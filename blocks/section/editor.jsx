...
const { PanelBody, Button, SelectControl, TextControl, ColorPalette, BaseControl, RangeControl, __experimentalToggleGroupControl, __experimentalToggleGroupControlOption } = wp.components;
    ...
    edit: function (props) {
        ...
        return (
            <Fragment>
                <InspectorControls>
                    {/* ═══════ BACKGROUND ═══════ */}
                    <PanelBody title={__('Background', 'snn')} initialOpen={true}>
